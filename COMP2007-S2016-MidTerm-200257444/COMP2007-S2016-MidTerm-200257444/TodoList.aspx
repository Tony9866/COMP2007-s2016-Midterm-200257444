<%@ Page Title="Todo List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TodoList.aspx.cs" Inherits="COMP2007_S2016_MidTerm_200257444.TodoList" %>
        ...
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                ...
                <asp:GridView runat="server" CssClass="table table-bordered table-striped table-hover" 
                    ID="TodosGridView" AutoGenerateColumns="false"
                    DataKeyNames="TodoID" 
                    OnRowDeleting="TodosGridView_RowDeleting"
                    AllowPaging="true" PageSize="3" OnPageIndexChanging="TodosGridVieww_PageIndexChanging"
                    AllowSorting="true" 
